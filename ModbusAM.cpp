...
This library is based on ModbusXT by caddish12
if you have any question, please feel free to contact me by email : ccurtins at datacomm dot ch
*/
#include "ModbusAM.h"
...
void Modbus::process_F3_F4()
{
	...
	if ( frame[2] == ( _packet->data * 2) )
	{
		...
		{
			_register_array[_packet->register_start_address + i] = ( frame[index] << 8) | frame[index+1];
